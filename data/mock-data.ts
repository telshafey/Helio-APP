...
export const mockPublicPagesContent: PublicPagesContent = {
    ...
    faq: {
        ...
        subtitle: "Helio بوابتك المتكاملة لقلب هليوبوليس الجديدة النابض بالحياة",
        categories: [
            {
                category: "عن التطبيق",
                items: [
                    { q: "ما هو تطبيق Helio؟", a: "Helio هو دليلك الرقمي الشامل لمدينة هليوبوليس الجديدة. تم تصميمه ليكون رفيقك اليومي، حيث يجمع كل الخدمات والمرافق والأخبار والعقارات، بالإضافة إلى مجتمع تفاعلي للسكان، كل ذلك في مكان واحد." },
                    { q: "من يستطيع استخدام التطبيق؟", a: "أي شخص يسكن أو يزور هليوبوليس الجديدة ويرغب في استكشاف الأماكن والخدمات المتاحة بسرعة ودقة." },
                    { q: "هل التطبيق مجاني؟", a: "نعم، تطبيق Helio مجاني تمامًا للتنزيل والاستخدام لجميع السكان والزوار." }
                ]
            },
            {
                category: "الحساب والمجتمع",
                items: [
                    { q: "هل يجب أن أسجل حسابًا؟ وما هي المزايا؟", a: "يمكنك تصفح معظم محتوى التطبيق بدون حساب. لكن، تسجيل حساب مجاني يمنحك مزايا حصرية مثل: إضافة الخدمات إلى قائمتك المفضلة، كتابة تقييمات للخدمات، المشاركة في قسم المجتمع، وحفظ إعداداتك الشخصية." },
                    { q: "ما هو قسم المجتمع؟", a: "قسم المجتمع هو مساحة تفاعلية لسكان هليوبوليس الجديدة. يمكنك طرح الأسئلة، بدء نقاشات عامة، عرض أغراض للبيع، أو الإعلان عن فعاليات وأحداث، والتواصل مباشرة مع جيرانك." },
                    { q: "كيف يمكنني التأكد من أمان معلوماتي؟", a: "نحن نأخذ خصوصيتك على محمل الجد. يتم تأمين جميع بياناتك ولا نشاركها مع أي طرف ثالث. لمزيد من التفاصيل، يمكنك مراجعة \"سياسة الخصوصية\" الخاصة بنا." }
                ]
            },
            {
                category: "استخدام التطبيق",
                items: [
                    { q: "كيف أبحث عن خدمة معينة؟", a: "يمكنك استخدام شريط البحث في الصفحة الرئيسية للعثور على أي شيء بسرعة. كما يمكنك تصفح دليل الخدمات المنظم حسب الفئات (مثل مطاعم، صحة، تعليم) للوصول إلى ما تريد بسهولة." },
                    { q: "كيف أجد مواعيد الباصات؟", a: "اذهب إلى قسم \"المواصلات\" من القائمة الرئيسية. ستجد هناك جداول مواعيد الباصات الداخلية والخارجية، بالإضافة إلى معلومات الاتصال بالمشرفين." },
                    { q: "كيف أصل إلى أرقام الطوارئ؟", a: "قسم \"الطوارئ\" في القائمة يوفر لك قائمة بأهم الأرقام للطوارئ داخل المدينة وعلى المستوى القومي، مع إمكانية الاتصال المباشر بلمسة واحدة." },
                    { q: "هل التطبيق يعمل بدون اتصال بالإنترنت؟", a: "التطبيق يحتاج اتصال بالإنترنت لعرض أحدث البيانات والمحتوى التفاعلي." }
                ]
            }
        ]
    },
